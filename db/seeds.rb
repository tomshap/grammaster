...
@submission1 = Submission.create(image_id: "1", gramventure_id: "1", votes: "")
@submission2 = Submission.create(image_id: "2", gramventure_id: "1", votes: "")
@submission3 = Submission.create(image_id: "5", gramventure_id: "2", votes: "")
@submission4 = Submission.create(image_id: "14", gramventure_id: "3", votes: "")
@submission5 = Submission.create(image_id: "13", gramventure_id: "4", votes: "")
@submission6 = Submission.create(image_id: "12", gramventure_id: "3", votes: "")
@submission7 = Submission.create(image_id: "4", gramventure_id: "1", votes: "")
@submission8 = Submission.create(image_id: "16", gramventure_id: "4", votes: "")
@submission9 = Submission.create(image_id: "8", gramventure_id: "2", votes: "")
@submission10 = Submission.create(image_id: "10", gramventure_id: "3", votes: "")
@submission11= Submission.create(image_id: "15", gramventure_id: "4", votes: "")
@submission12= Submission.create(image_id: "9", gramventure_id: "3", votes: "")
@submission13 = Submission.create(image_id: "11", gramventure_id: "3", votes: "")
@submission14 = Submission.create(image_id: "3", gramventure_id: "1", votes: "")
@submission15= Submission.create(image_id: "6", gramventure_id: "2", votes: "")
@submission16 = Submission.create(image_id: "7", gramventure_id: "2", votes: "")
@image1 = Image.create(url: "http://smithersfeedstore.com/wp-content/uploads/2015/05/gardening101.jpg", user_id: "")
@image2 = Image.create(url: "http://teamworkshealth.ca/wp-content/uploads/Gardening-HD-Wallpaper-2.jpg", user_id: "")
@image3 = Image.create(url: "http://cdn01.cdn.justjared.com/wp-content/uploads/2009/06/obama-garden/michelle-obama-white-house-kitchen-garden-03.jpg", user_id: "")
@image4 = Image.create(url: "http://landscapingchennai.com/wp-content/uploads/2015/08/How-to-make-an-Outdoor-Cactus-Garden.jpg", user_id: "")
@image5 = Image.create(url: "http://swedbrand.com/blog/wp-content/uploads/2015/12/22.12.jpg", user_id: "")
@image6 = Image.create(url: "http://d75822.medialib.glogster.com/internetprincess099aa/media/1c/1c289d6f153f89389a4444ae5fcee3ecedc84bd4/neon-lights-1280x800.jpg", user_id: "")
@image7 = Image.create(url: "http://api.ning.com/files/DtcI2O2Ry7BagL9VAv-Hjns1uxv0knlSppNaYeiVYF7x2VuGdAaqrXtdkNSSEco1HErfq81ZNBGm8FpeabrambQgFLItYHsm/1082136887.jpeg", user_id: "")
@image8 = Image.create(url: "http://img10.deviantart.net/a23a/i/2009/088/3/2/bleeding_neon_lights_by_31enrose36.jpg", user_id: "")
@image9 = Image.create(url: "https://s3.amazonaws.com/GBrief/uploads/article/preview_image/565/ROAD-TRIP-facebook.jpg", user_id: "")
@image10 = Image.create(url: "http://globetrottingstiletto.com/wp-content/uploads/2016/03/9183-12743093-HolidayRoadTrip_LauraAustin_332_jpg.jpg", user_id: "")
@image11 = Image.create(url: "http://data.whicdn.com/images/135793416/original.jpg", user_id: "")
@image12 = Image.create(url: "https://c2.staticflickr.com/4/3919/14600924786_b99632ce17_b.jpg", user_id: "")
@image13 = Image.create(url: "http://www.delcopetcare.com/wp-content/uploads/2013/02/dog-walking.jpg", user_id: "")
@image14 = Image.create(url: "http://www.pets4homes.co.uk/images/articles/1231/large/walking-a-reactive-dog-on-the-lead-529213a02fdef.jpg", user_id: "")
@image15 = Image.create(url: "https://www.rover.com/blog/wp-content/uploads/2014/12/walking-dog.jpg", user_id: "")
@image16 = Image.create(url: "http://www.dogtipper.com/products-photos/uploaded_images/2EzyDogsWalking5x7-705479.jpg", user_id: "")